...
def main():
    ...
    if 'data' in st.session_state:
        ...
        st.header("Traditional Ad Ideas")
        for ad in st.session_state['traditional_ads']:
            st.write(f"**{ad['type']}:** {ad['content']}")

        st.header("AI-Generated Ad Ideas")
        if st.session_state['ai_ads']:
            for ad in st.session_state['ai_ads']['data']:
                st.write(ad)
        else:
            st.write("No AI-generated ads available.")
